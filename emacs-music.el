...
(defvar youtube-player-command "mpv --ytdl-format 134+171 ")
...
(defun youtube(filename)
  (interactive "sWhat to Play:")
  (setq youtube-command (concat youtube-player-command filename))
  (call-process-shell-command youtube-command nil 0)
)
(defun nomusic()
  (interactive)
...
(defun nasheradio()
  (interactive)
  (music-url "http://nashe128.streamr.ru")
)
(defun music-toggle()
  (interactive)
